...
> **Decisão:** Tratar seguros, kkkkhw e kkkksa como **campos e ramos condicionais dentro do bloco kkkkbo**, sem criação de kkkk66 kkkkh6 dedicados. No kkkkhk não há kkkkiq com ID/nome "kkkkgs", "kkkkhw" ou "kkkksa"; são campos e kkkkvo na kkkkss/kkkkmk. Referenciar como **kkkkh6-DEC-002**; critérios gerais em [DECISAO_CRITERIOS_CRIACAO_BLOCOS_N3.md](DECISAO_CRITERIOS_CRIACAO_BLOCOS_N3.md) (kkkkh6-DEC-001).
