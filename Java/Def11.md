# Decisão kkkk5u: Voltar macro — kkkkgo (mensagem) ou kkkkgp (kkkkhj devolve kkkkvo)?

> **Contexto:** kkkkfh do [kkkk3a](../kkkk5e%20da%20decomposição/kkkk3a). Quando o usuário clica em **Voltar** numa etapa (ex.: kkkkwt), o kkkkh0 precisa sair do kkkkhj atual e reabrir o kkkkhj anterior (ex.: kkkkeh). Duas formas de implementar: (A) mensagem de fora + kkkkbu no kkkkh0; (B) kkkkhj termina e devolve kkkkvo.  
