...
| **Integração externa relevante** | Service kkkk8l, kkkkem ou External kkkk8l que representa integração com kkkkxv externo e merece destaque no kkkk5f. | kkkkck (kkkkja kkkkhg); kkkkcc (kkkkfl kkkkdh). |
...
| **Opção de produto** | Nome de produto, kkkksu ou opção comercial exibida na kkkkss/kkkkmk, sem ID de kkkk9q correspondente. | kkkkgs, kkkkhw, kkkksa como *opções* na tela de kkkkst. |
...
Subprocessos e blocos kkkkh6 devem representar **lógica de kkkk55** (atividades, kkkkgc, kkkkwd, kkkkyr de domínio). Campos de formulário e opções de produto **não justificam** blocos kkkkh6 dedicados; eles são descritos no bloco que contém a kkkk9q de kkkkss/kkkkmk onde aparecem.
