...
def PP3934PP2617Npc = new JsonSlurperClassic()
  .parseText(PP3606.PP3665('PP3417').toString())
  .PP3944

def textoPreenchido = { it != null &amp;&amp; !it.toString().trim().isEmpty() }

def camposFaltantes = []
if (!textoPreenchido(PP3606.PP3665('PP3282'))) { camposFaltantes &lt;&lt; 'PP3282' }
if (!textoPreenchido(PP3606.PP3665('codigo_PP3200_origem'))) { camposFaltantes &lt;&lt; 'codigo_PP3200_origem' }
// TODO[DD0001]: validar com equipe se fallPP3123 PP3203 -> PP3200_origem continua regra oficial de negocio.
def subPP3200Origem = (PP3606.PP3665('PP3203') ?: PP3606.PP3665('PP3200_origem') ?: '').toString().trim()
if (!textoPreenchido(subPP3200Origem)) { camposFaltantes &lt;&lt; 'PP3203/PP3200_origem' }

if (!camposFaltantes.isEmpty()) {
  PP3606.PP4250('PP4000FormalizacaoNpcIncompleto', JsonOutput.toJson([
    mensagem: 'Campos obrigatorios ausentes para formalizacao PP2627',
...
def statusValiPP3394aoPP2751Npc = PP3606.PP3665('PP4275')
def idPP2751ParaFormalizacao =
  statusValiPP3394aoPP2751Npc == 'Sucesso' &amp;&amp; textoPreenchido(PP3934PP2617Npc.PP4091)
    ? PP3934PP2617Npc.PP4091
    : null

PP3606.PP4250('PP3747_para_formalizacao', PP3934PP2617Npc.PP3747)
...
def corpoFormalizacaoNpc = [
    idintencao: PP3934PP2617Npc.PP3747,
    pessoa: [PP3732: String.valueOf(PP3606.PP3665('PP3282') ?: '')],
    PP3200: [
      PP3200Origem: String.valueOf(PP3606.PP3665('codigo_PP3200_origem') ?: ''),
      subPP3200Origem: subPP3200Origem
    ],
    PP3350: [
      tipo: String.valueOf(PP3606.PP3665('codigo_PP4326') ?: ''),
      PP4229: String.valueOf(PP3606.PP3665('PP3291') ?: '')
    ],
    PP4045Escolhidos: [[
        idOferta: PP3934PP2617Npc.id_PP3934,
        idProdutoOferta: PP3934PP2617Npc.PP3758,
        PP3833CreditoSelecionado: new BigDecimal(PP3934PP2617Npc.PP3840.toString().trim()).intValueExact(),
        dataVencimento: Integer.parseInt(PP3934PP2617Npc.PP3530.toString().trim()),
        PP4015: [idPP2698: PP3934PP2617Npc.PP3756]
    ]]
]

if (idPP2751ParaFormalizacao != null) {
    corpoFormalizacaoNpc.PP4045Escolhidos[0].idAtrelamentoPP0573 = idPP2751ParaFormalizacao
}
