# Mapa de jornadas (User Journeys) — kkkkho

Conecta **kkkklz e canais** ao kkkkhk: como o kkkk38 e o kkkk1x vivem a kkkkgq, incluindo kkkk3w, continuação remota e fallback.

A kkkkgq do usuário percorre etapas que correspondem aos **kkkk0n orquestrados pelo kkkkfz**. Cada etapa da kkkklz mapeia para um kkkkft (kkkke2, Dados, Produtos, kkkk56, kkkk7y).

**Fonte:** transcrições, DIVISAO_BPMN_V2_NOVA_JORNADA, ADRs (kkkkuz, kkkkfd).
...
*Legenda:* kkkke2 = kkkkgx | Dados = kkkkgy | Produtos = kkkkgz | kkkk56 = kkkkg0 | kkkkcl | kkkk7y = kkkk65 do kkkkg0.
...
kkkkv7 inicia kkkk3l (kkkkf0 / kkkk1o)
    |
    v
kkkkty (segmento, kkkk1o, kkkk8g) — kkkkgx
    |
    v
Dados pessoais (kkkk1x preenche nome, kkkkw5, e-mail, endereço, kkkksy) — kkkkgy
    |
    v
Produtos e serviços (kkkkss, kkkksp, kkkkia, kkkkmk, termos) — kkkkgz
    |
    v
kkkk56 (kkkks4, kkkkiu, resumo, liberação) — kkkkg0
    |
    v
Sistema valida e gera kkkkhu; envia e-mail se aplicável
    |
    v
...
kkkkv7 na etapa de kkkke2 aciona "kkkkui"
    |
    v
Sistema gera link (kkkkvd) e envia por e-mail/SMS ao kkkk1x
    |
    v
...
```text
Usuário está em Produtos (kkkkid) e aciona "Voltar"
    |
    v
Destino desejado: Coleta de kkkkiu (kkkk56 — kkkkg0)
    |
    v
kkkkra envia evento de kkkkgu com destino (kkkksi)
    |
    v
...
| kkkkmf | Presencial (kkkk1o) | Dados, kkkkst, kkkkth (ou parte) |
| kkkkmf | Remoto (link kkkk3w) | Retomada fora da kkkk1o |
| kkkkmf | Biometria (QR/WhatsApp/SMS) | kkkk56 kkkks4 |
| Sistema | E-mail / SMS | kkkkuz, kkkkhu, notificações |
| kkkk7u | Ferramenta analista | Fraude, kkkk03 |
...
- **Biometria recusada / não elegível:** fluxos de exceção no kkkkg0; proposta_biometria_recusada ou kkkkm8.
- **kkkklg expirada (expurgo):** retomada por kkkk3w negada; orientar usuário (kkkk2h, expiração).
