...
if (PP3606.PP3665("PP3944").get("PP3370") == true &amp;&amp; PP3606.PP3665("PP3944").get("PP3840") != null) {
        PP4409_credito = PP3606.PP3665("PP3944").get("PP3840").toString()
}

var PP3520 = aplicaRegraPersonDnPP0573(PP4409_credito, PP3521, PP3522) //codigo 0000 debito

function aplicaRegraPersonDnPP0573(valorPreAprovado,
dnPP0573Credito,
dnPP0573Debito){
    ...
    <bpmn:servicePP2865 id="PP4378" name="PP2990" camunda:modelerTemplate="PP3965" camunda:modelerTemplateVersion="1" PP3191="true" PP3193="${PP3967}">
      <bpmn:extensionElements>
        <camunda:PP3789>
          <camunda:inputParameter name="withError">true</camunda:inputParameter>
          <camunda:inputParameter name="PP3585">${statusCode != 200}</camunda:inputParameter>
          <camunda:inputParameter name="errorCode">PP0538_PROXY_PP2627</camunda:inputParameter>
          <camunda:inputParameter name="PP3417">
            <camunda:map>
          ...
          <camunda:inputParameter name="urlDev">https://cards-multiple-noname.api-sp.dev.aws.cloud.ihf/cards-multiple-noname/v1/proxies/${S(PP3417).prop('PP3944').prop('PP4091').stringValue()}/cards-details</camunda:inputParameter>
          <camunda:inputParameter name="PP4363">https://cards-multiple-noname.api-sp.hom.aws.cloud.ihf/cards-multiple-noname/v1/proxies/${S(PP3417).prop('PP3944').prop('PP4091').stringValue()}/cards-details</camunda:inputParameter>
          <camunda:inputParameter name="urlProd">https://cards-multiple-noname.api-sp.prod.aws.cloud.ihf/cards-multiple-noname/v1/proxies/${S(PP3417).prop('PP3944').prop('PP4091').stringValue()}/cards-details</camunda:inputParameter>
...
def PP3934Npc = dadosPP2726.PP3944;
def statusValiPP3394aoPP2751Npc = PP3606.hasVariable('PP4275') ? PP3606.PP3665('PP4275') : null;

def idIntencaoGlobal = PP3934Npc.PP3747;
def idPP2751ParaFormalizacao = null;

if (statusValiPP3394aoPP2751Npc == 'Sucesso' &amp;&amp; PP3934Npc.PP4091 != null &amp;&amp; !PP3934Npc.PP4091.toString().trim().isEmpty()) {
    idPP2751ParaFormalizacao = PP3934Npc.PP4091;
}

PP3606.PP4250('PP3747_para_formalizacao', idIntencaoGlobal);
PP3606.PP4250('id_PP4087_para_formalizacao', idPP2751ParaFormalizacao);
PP3606.PP4250('status_formalizacao_npc', 'Erro');

def PP3732 = PP3606.PP3665('PP3282') ?: '';
def PP3200Origem = PP3606.PP3665('codigo_PP3200_origem') ?: '';
// TODO[DD0001]: validar com equipe se fallPP3123 PP3203 -> PP3200_origem continua regra oficial de negocio.
def subPP3200OrigemRaw = PP3606.PP3665('PP3203') ?: PP3606.PP3665('PP3200_origem');
if (subPP3200OrigemRaw == null) {
    println "[ERROR][${PP3606.PP3665('PP3759')}][FormalizacaoPP2627] Campo obrigatorio ausente: PP3200.subPP3200Origem (PP3203/PP3200_origem)";
}
def subPP3200Origem = subPP3200OrigemRaw.toString().trim();
if (subPP3200Origem.isEmpty()) {
    println "[ERROR][${PP3606.PP3665('PP3759')}][FormalizacaoPP2627] Campo obrigatorio vazio: PP3200.subPP3200Origem (PP3203/PP3200_origem)";
}
def tipoPP0664 = PP3606.PP3665('codigo_PP4326') ?: '';
def PP4229PP0664 = PP3606.PP3665('PP3291') ?: '';
def PP3833PreAprovadoRaw = PP3934Npc.PP3840;
def dtVencimentoRaw = PP3934Npc.PP3530;


def PP3833CreditoSelecionado = new BigDecimal(PP3833PreAprovadoRaw.toString().trim()).intValueExact();
def dataVencimento = Integer.parseInt(dtVencimentoRaw.toString().trim());

def bodyFormalizaNpc = [
    idintencao: idIntencaoGlobal,
    pessoa: [
        PP3732: String.valueOf(PP3732)
    ],
    PP3200: [
        PP3200Origem: String.valueOf(PP3200Origem),
        subPP3200Origem: String.valueOf(subPP3200Origem)
    ],
    PP3350: [
        tipo: String.valueOf(tipoPP0664),
        PP4229: String.valueOf(PP4229PP0664)
    ],
    PP4045Escolhidos: [[
        idOferta: PP3934Npc.id_PP3934,
        idProdutoOferta: PP3934Npc.PP3758,
        PP3833CreditoSelecionado: PP3833CreditoSelecionado,
        dataVencimento: dataVencimento,
        PP4015: [
            idPP2698: PP3934Npc.PP3756
        ]
    ]]
]

if (idPP2751ParaFormalizacao != null) {
    bodyFormalizaNpc.PP4045Escolhidos[0].idAtrelamentoPP0573 = idPP2751ParaFormalizacao;
}

PP3606.PP4250('PP3641_body', JsonOutput.toJson(bodyFormalizaNpc));</bpmn:PP4199>
    </bpmn:PP4199PP2865>
    ...
    <bpmn:servicePP2865 id="PP3641" name="PP2242" camunda:modelerTemplate="PP3966" camunda:modelerTemplateVersion="1" PP3191="true" PP3193="${operacaoPostDelegate}">
      <bpmn:extensionElements>
        <camunda:PP3789>
          <camunda:inputParameter name="withError">true</camunda:inputParameter>
          <camunda:inputParameter name="PP3585">${statusCode != 200}</camunda:inputParameter>
          <camunda:inputParameter name="errorCode">erro_PP3641</camunda:inputParameter>
          ...
          <camunda:outputParameter name="status_formalizacao_npc">Sucesso</camunda:outputParameter>
        </camunda:PP3789>
      </bpmn:extensionElements>
    ...
    <bpmn:userPP2865 id="PP3416" name="PP0726" PP3476="PP2203">
      <bpmn:extensionElements>
        <camunda:formData>
          ...
          <PP3196 id="PP3944" label="Oferta PP2620 PP2627" type="object">
            <camunda:properties>
              <camunda:PP4047 id="PP3370" value="Obrigatório" />
              <camunda:PP4047 id="PP3758" value="Obrigatório" />
              <camunda:PP4047 id="id_PP3934" value="Obrigatório" />
              <camunda:PP4047 id="PP3756" value="Obrigatório" />
              <camunda:PP4047 id="PP3747" value="Obrigatório" />
              <camunda:PP4047 id="nome_PP4044" value="Opcional" />
              <camunda:PP4047 id="descricao" value="Opcional" />
              <camunda:PP4047 id="anuidade" value="Opcional" />
              <camunda:PP4047 id="PP3833_minimo_disponivel" value="Opcional" />
              <camunda:PP4047 id="PP3840" value="Obrigatório" />
              <camunda:PP4047 id="PP3129" value="Opcional" />
              <camunda:PP4047 id="dn" value="Opcional" />
              <camunda:PP4047 id="PP3530" value="Obrigatório" />
              <camunda:PP4047 id="PP4091" value="Opcional" />
            </camunda:properties>
          </PP3196>
          ...
          <PP3196 id="nome_PP4044" type="string" />
          <PP3196 id="descricao" type="string" />
        ...
        <camunda:PP3789>
          ...
          <camunda:inputParameter name="PP3945">
            <camunda:list>
              ...
              <camunda:value>nome_PP4044</camunda:value>
              <camunda:value>descricao</camunda:value>
        ...
        <camunda:PP3789>
          ...
          <camunda:inputParameter name="PP3875">
            <camunda:map>
              ...
              <camunda:entry key="PP3753">$</camunda:entry>
              <camunda:entry key="PP3416">$</camunda:entry>
              <camunda:entry key="PP3946">${PP3606.PP3665("caso_eh_npc") == true}</camunda:entry>
...
def PP3913_PP3350 = dados_PP3350 ? dados_PP3350["PP3913_PP3350"] : ""; def PP3394_PP3350 = dados_PP3350 ? dados_PP3350["PP3394_PP3350"] : ""; def PP3055 = dados_PP3350 ? dados_PP3350["codigo_PP3053"] : ""; def PP3350_corrente_com_PP3394 = PP3913_PP3350 + PP3394_PP3350def PP3365_pagadoras_fmt = PP3365_pagadoras ? PP3365_pagadoras.collect {
    ...
    <bpmn:PP4199PP2865 id="mapeia_flags_formalizacao_npc" name="Mapeia flags formalizacao PP2627" PP4199Format="groovy">
      <bpmn:incoming>PP2075</bpmn:incoming>
      <bpmn:outgoing>PP12560hfkaa8</bpmn:outgoing>
      <bpmn:PP4199>import groovy.json.JsonOutput
import groovy.json.JsonSlurperClassic

def PP3934Npc = new JsonSlurperClassic()
  .parseText(PP3606.PP3665('PP3417').toString())
  .PP3944;

boolean casoEhNpc = PP3934Npc != null;
// TODO[DD0001]: validar com equipe se fallPP3123 PP3203 -> PP3200_origem continua regra oficial de negocio.
def subPP3200Origem = PP3606.PP3665('PP3203') ?: PP3606.PP3665('PP3200_origem');

def textoPreenchido = { it != null &amp;&amp; it.toString().trim() != '' }

boolean npcPP0722ObrigatoriosOk =
  casoEhNpc &amp;&amp;
  textoPreenchido(PP3606.PP3665('PP3282')) &amp;&amp;
  textoPreenchido(PP3606.PP3665('codigo_PP3200_origem')) &amp;&amp;
  textoPreenchido(subPP3200Origem);

PP3606.PP4250('caso_eh_npc', casoEhNpc);
PP3606.PP4250('npc_dados_obrigatorios_ok', npcPP0722ObrigatoriosOk);

if (casoEhNpc &amp;&amp; !npcPP0722ObrigatoriosOk) {
  def camposFaltantes = [];
        
  if (!textoPreenchido(PP3606.PP3665('PP3282'))) {
        camposFaltantes &lt;&lt; 'PP3282';
  }
  if (!textoPreenchido(PP3606.PP3665('codigo_PP3200_origem'))) {
        camposFaltantes &lt;&lt; 'codigo_PP3200_origem';
  }
  if (!textoPreenchido(subPP3200Origem)) {
        camposFaltantes &lt;&lt; 'PP3203/PP3200_origem';
  }

  def erroNpcPP0722Obrigatorios = [
    mensagem: 'PP0722 obrigatorios ausentes para valiPP3394ao de PP4087 PP2627; falha sera tratada na integracao',
    campos_faltantes: camposFaltantes,
    PP3366o: [
      PP3759: PP3606.PP3665('PP3759'),
      correlation_id: PP3606.PP3665('PP4481')
    ]
  ]

  PP3606.PP4250('erro_npc_dados_obrigatorios', JsonOutput.toJson(erroNpcPP0722Obrigatorios));
}

if (casoEhNpc) {
  PP3606.PP4250('PP3747', PP3934Npc.PP3747);
  PP3606.PP4250('PP4408', PP3934Npc.PP3840);
}

</bpmn:PP4199>
    </bpmn:PP4199PP2865>
    <bpmn:sequenceFlow id="PP1746" sourceRef="PP4063" targetRef="PP3480" />
    <bpmn:sequenceFlow id="PP2075" sourceRef="PP3480" targetRef="mapeia_flags_formalizacao_npc" />
    ...
    <bpmn:sequenceFlow id="PP2087" sourceRef="PP2408" targetRef="PP4378">
      <bpmn:conditionExpression xsi:type="bpmn:tFormalExpression">${PP3606.PP3665("caso_eh_npc") == true}</bpmn:conditionExpression>
    </bpmn:sequenceFlow>
    <bpmn:sequenceFlow id="PP1550" sourceRef="PP2408" targetRef="PP0058">
      <bpmn:conditionExpression xsi:type="bpmn:tFormalExpression">${PP3606.PP3665("caso_eh_npc") != true}</bpmn:conditionExpression>
    </bpmn:sequenceFlow>
    <bpmn:parallelPP2253 id="PP2354">
      <bpmn:incoming>PP12560hfkaa8</bpmn:incoming>
    ...
    <bpmn:sequenceFlow id="PP12560hfkaa8" sourceRef="mapeia_flags_formalizacao_npc" targetRef="PP2354" />
  ...
  <bpmndi:PP0227Diagram id="PP0238">
    <bpmndi:PP0227Plane id="PP0305" bpmnElement="PP3951">
      ...
      <bpmndi:PP0227Shape id="PP0142" bpmnElement="PP3860" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="25090" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0050" bpmnElement="PP3536" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="25580" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0112" bpmnElement="PP3373" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="24636" y="860" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2397" bpmnElement="PP2396">
        <dc:Bounds x="24053" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2416" bpmnElement="PP2415">
        <dc:Bounds x="24963" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0960" bpmnElement="PP1225">
        <dc:Bounds x="25612" y="672" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25601" y="715" width="76" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1025" bpmnElement="PP3816">
        <dc:Bounds x="24418" y="690" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="24406" y="726" width="73" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0143" bpmnElement="PP4064" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="27378" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2366" bpmnElement="PP2270">
        <dc:Bounds x="25445" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2383" bpmnElement="PP2296">
        <dc:Bounds x="25781" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0127" bpmnElement="PP3932" bioc:stroke="#5b176d" bioc:fill="#e1bee7" color:PP3123ground-color="#e1bee7" color:border-color="#5b176d">
        <dc:Bounds x="24636" y="668" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2346" bpmnElement="PP2345" isMarkerVisible="true">
        <dc:Bounds x="24851" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0929" bpmnElement="PP4352">
        <dc:Bounds x="24418" y="796" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="24420" y="839" width="45" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2386" bpmnElement="PP2440">
        <dc:Bounds x="24301" y="683" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1111" bpmnElement="PP4320">
        <dc:Bounds x="24518" y="796" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="24527" y="773" width="18" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP1218" bpmnElement="PP3363" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="26210" y="1286" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26186" y="1262" width="84" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1169" bpmnElement="PP1168">
        <dc:Bounds x="26560" y="1286" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0098" bpmnElement="PP3110" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="26366" y="1264" width="100" height="80" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2393" bpmnElement="PP2392" isMarkerVisible="true">
        <dc:Bounds x="27701" y="545" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27688" y="500" width="82" height="40" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0144" bpmnElement="PP4379" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="27676" y="662" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2365" bpmnElement="PP2364" isMarkerVisible="true">
        <dc:Bounds x="27861" y="677" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27804" y="657" width="85" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0077" bpmnElement="PP3541" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="27996" y="662" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0149" bpmnElement="PP3099" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="28358" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2328" bpmnElement="PP2327" isMarkerVisible="true">
        ...
        <bpmndi:PP0227Label>
          <dc:Bounds x="26879" y="495" width="74" height="40" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0046" bpmnElement="PP4283">
        <dc:Bounds x="27046" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2286" bpmnElement="PP2285" isMarkerVisible="true">
        <dc:Bounds x="27251" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0075" bpmnElement="PP3885" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="26986" y="662" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0103" bpmnElement="PP3570" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="27126" y="662" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2262" bpmnElement="PP2261" isMarkerVisible="true">
        <dc:Bounds x="29090" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0318" bpmnElement="PP3544" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="29668" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0326" bpmnElement="PP4075" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="29869" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0331" bpmnElement="PP1003">
        <dc:Bounds x="30030" y="552" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0491" bpmnElement="PP3539" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="29338" y="875" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0342" bpmnElement="PP2417" isMarkerVisible="true">
        <dc:Bounds x="29499" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0478" bpmnElement="PP2348">
        <dc:Bounds x="29227" y="755" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0384" bpmnElement="PP3540" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="29338" y="740" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0392" bpmnElement="PP2372">
        <dc:Bounds x="29499" y="755" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0352" bpmnElement="PP1156" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="29234" y="667" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="29157" y="678" width="67" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0419" bpmnElement="PP2298" isMarkerVisible="true" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="29227" y="545" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="29265" y="523" width="71" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0469" bpmnElement="PP2434" isMarkerVisible="true" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="28657" y="545" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="28648" y="523" width="83" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1015" bpmnElement="PP1074" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="29620" y="647" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="29632" y="690" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0145" bpmnElement="PP3113" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="28188" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0473" bpmnElement="PP3861" bioc:stroke="#1e88e5" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#1e88e5">
        <dc:Bounds x="26401" y="660" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0323" bpmnElement="PP0971" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="25993" y="682" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25986" y="658" width="49" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0486" bpmnElement="PP3334" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="26103" y="660" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0416" bpmnElement="PP2412" isMarkerVisible="true" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="26277" y="675" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26257" y="653" width="90" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0449" bpmnElement="PP0926" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="26284" y="804" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26260" y="847" width="84" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2361" bpmnElement="PP2360" isMarkerVisible="true">
        <dc:Bounds x="26600" y="797" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26531" y="808" width="59" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2313" bpmnElement="PP2312" isMarkerVisible="true">
        <dc:Bounds x="26600" y="923" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26606" y="983" width="54" height="40" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0344" bpmnElement="PP4177">
        <dc:Bounds x="26766" y="908" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0394" bpmnElement="PP1192">
        <dc:Bounds x="25993" y="930" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25980" y="976" width="72" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0120" bpmnElement="PP3887" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="24138" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0409" bpmnElement="PP3933" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="24276" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0059" bpmnElement="PP0058" isExpanded="true">
        <dc:Bounds x="22008" y="390" width="1370" height="720" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1013" bpmnElement="PP1012">
        <dc:Bounds x="22048" y="479" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0396" bpmnElement="PP2300" isMarkerVisible="true">
        <dc:Bounds x="22123" y="472" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22116" y="450" width="68" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0373" bpmnElement="PP2320" isMarkerVisible="true">
        <dc:Bounds x="23183" y="472" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0463" bpmnElement="PP4451" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="22328" y="667" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0330" bpmnElement="PP2355" isMarkerVisible="true">
        <dc:Bounds x="22583" y="682" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0407" bpmnElement="PP3584">
        <dc:Bounds x="22948" y="897" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0432" bpmnElement="PP1119">
        <dc:Bounds x="22590" y="809" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0414" bpmnElement="PP1088">
        <dc:Bounds x="22360" y="549" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22367" y="535" width="22" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0324" bpmnElement="PP4085" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="22948" y="667" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0381" bpmnElement="PP2439">
        <dc:Bounds x="22743" y="682" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0364" bpmnElement="PP2349">
        <dc:Bounds x="22743" y="912" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0379" bpmnElement="PP1101">
        <dc:Bounds x="23110" y="689" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0404" bpmnElement="PP2282" isMarkerVisible="true">
        <dc:Bounds x="22353" y="913" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0428" bpmnElement="PP1107">
        <dc:Bounds x="22130" y="809" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22160" y="797" width="16" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0446" bpmnElement="PP2284">
        <dc:Bounds x="22973" y="802" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0347" bpmnElement="PP4322">
        <dc:Bounds x="22230" y="689" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22217" y="728" width="65" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0393" bpmnElement="PP2336" isMarkerVisible="true">
        <dc:Bounds x="22583" y="912" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1165" bpmnElement="PP1164">
        <dc:Bounds x="23280" y="479" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0417" bpmnElement="PP1108">
        <dc:Bounds x="22360" y="729" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Edge id="PP2001" bpmnElement="PP2000">
        <di:waypoint x="22084" y="497" />
        <di:waypoint x="22123" y="497" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0296" bpmnElement="PP1336">
        <di:waypoint x="22173" y="497" />
        <di:waypoint x="23183" y="497" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0295" bpmnElement="PP1478">
        <di:waypoint x="22148" y="522" />
        <di:waypoint x="22148" y="707" />
        <di:waypoint x="22230" y="707" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0292" bpmnElement="PP2117">
        <di:waypoint x="22768" y="682" />
        <di:waypoint x="22768" y="497" />
        <di:waypoint x="23183" y="497" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0275" bpmnElement="PP1793">
        <di:waypoint x="23023" y="827" />
        <di:waypoint x="23208" y="827" />
        <di:waypoint x="23208" y="522" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1415" bpmnElement="PP1414">
        <di:waypoint x="23233" y="497" />
        <di:waypoint x="23280" y="497" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0280" bpmnElement="PP1386">
        <di:waypoint x="22266" y="707" />
        <di:waypoint x="22328" y="707" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0290" bpmnElement="PP1630">
        <di:waypoint x="22428" y="707" />
        <di:waypoint x="22583" y="707" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0244" bpmnElement="PP2101">
        <di:waypoint x="22633" y="707" />
        <di:waypoint x="22743" y="707" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22643" y="693" width="78" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0284" bpmnElement="PP1741">
        <di:waypoint x="22608" y="732" />
        <di:waypoint x="22608" y="809" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22618" y="742" width="50" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0270" bpmnElement="PP1614">
        <di:waypoint x="22608" y="682" />
        <di:waypoint x="22608" y="567" />
        <di:waypoint x="22396" y="567" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22490" y="552" width="39" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0247" bpmnElement="PP1810">
        <di:waypoint x="22793" y="937" />
        <di:waypoint x="22948" y="937" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0276" bpmnElement="PP1348">
        <di:waypoint x="23048" y="937" />
        <di:waypoint x="23078" y="937" />
        <di:waypoint x="23078" y="957" />
        <di:waypoint x="23048" y="957" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0256" bpmnElement="PP1282">
        <di:waypoint x="22998" y="897" />
        <di:waypoint x="22998" y="852" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0302" bpmnElement="PP1691">
        <di:waypoint x="22608" y="845" />
        <di:waypoint x="22608" y="912" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0301" bpmnElement="PP2023">
        <di:waypoint x="22360" y="567" />
        <di:waypoint x="22148" y="567" />
        <di:waypoint x="22148" y="707" />
        <di:waypoint x="22230" y="707" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Shape id="PP0052" bpmnElement="PP4043" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="21808" y="660" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0442" bpmnElement="PP3588">
        <dc:Bounds x="21860" y="792" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="21904" y="797" width="80" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0470" bpmnElement="PP3102" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="21808" y="878" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0980" bpmnElement="PP0979">
        <dc:Bounds x="21840" y="1002" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0359" bpmnElement="PP0974">
        <dc:Bounds x="21810" y="792" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="21735" y="791" width="73" height="40" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1186" bpmnElement="PP1185">
        <dc:Bounds x="22222" y="163" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22201" y="199" width="78" height="40" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1182" bpmnElement="PP1181">
        <dc:Bounds x="22222" y="303" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="22201" y="339" width="78" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0139" bpmnElement="PP4378" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="21808" y="211" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="Activity_monta_body_PP3641_di" bpmnElement="monta_body_PP3641" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="22290" y="211" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0138" bpmnElement="PP3641" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="22520" y="211" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2260" bpmnElement="PP2259" isMarkerVisible="true">
        <dc:Bounds x="23545" y="545" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="23605" y="563" width="78" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0336" bpmnElement="PP2418" isMarkerVisible="true">
        <dc:Bounds x="23945" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0390" bpmnElement="PP4203" bioc:stroke="#1e88e5" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#1e88e5">
        <dc:Bounds x="23650" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0488" bpmnElement="PP3044" bioc:stroke="#43a047" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#43a047">
        <dc:Bounds x="23800" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2359" bpmnElement="PP2358" isMarkerVisible="true">
        <dc:Bounds x="26891" y="677" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0465" bpmnElement="PP2382" isMarkerVisible="true">
        <dc:Bounds x="27251" y="677" width="50" height="50" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2368" bpmnElement="PP2367" isMarkerVisible="true">
        <dc:Bounds x="28545" y="545" width="50" height="50" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="28530" y="602" width="82" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0427" bpmnElement="PP4077" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="29869" y="428" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0334" bpmnElement="PP3659" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="28950" y="658" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0339" bpmnElement="PP3859" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="28770" y="658" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0306" bpmnElement="PP3858" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="28770" y="530" width="100" height="80" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0484" bpmnElement="PP3658" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="28950" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0311" bpmnElement="PP3480" bioc:stroke="#205022" bioc:fill="#c8e6c9" color:PP3123ground-color="#c8e6c9" color:border-color="#205022">
        <dc:Bounds x="21420" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="Activity_0e6n3f8_di" bpmnElement="mapeia_flags_formalizacao_npc" bioc:stroke="#0d4372" bioc:fill="#bbdefb" color:PP3123ground-color="#bbdefb" color:border-color="#0d4372">
        <dc:Bounds x="21620" y="530" width="100" height="80" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2309" bpmnElement="PP2408" isMarkerVisible="true">
        <dc:Bounds x="21833" y="425" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0227Shape_04tbwni" bpmnElement="PP2354">
        <dc:Bounds x="21833" y="545" width="50" height="50" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2899" bpmnElement="PP2898">
        <dc:Bounds x="24406" y="647" width="100" height="26" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2485" bpmnElement="PP2484">
        <dc:Bounds x="19708" y="390" width="2282" height="720" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="20993" y="397" width="84" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2477" bpmnElement="PP2476">
        <dc:Bounds x="23468" y="390" width="4055" height="720" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25508" y="416" width="52" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2897" bpmnElement="PP2896">
        <dc:Bounds x="24406" y="771" width="100" height="30" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2462" bpmnElement="PP2461" bioc:stroke="#000" bioc:fill="#fff">
        <dc:Bounds x="26168" y="1169" width="460" height="265" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26496" y="1176" width="84" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP2469" bpmnElement="PP2468">
        <dc:Bounds x="27546" y="390" width="950" height="720" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27997" y="397" width="66" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP2475" bpmnElement="PP2474">
        <dc:Bounds x="28506" y="390" width="1612" height="720" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0482" bpmnElement="PP2900">
        <dc:Bounds x="22218" y="648" width="70" height="30" />
        <bpmndi:PP0227Label />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP1184" bpmnElement="PP1183">
        <dc:Bounds x="21890" y="253" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0934" bpmnElement="PP0956">
        <dc:Bounds x="21860" y="722" width="36" height="36" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0487" bpmnElement="PP1005">
        <dc:Bounds x="24308" y="592" width="36" height="36" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Shape id="PP0350" bpmnElement="PP0959">
        <dc:Bounds x="26607" y="722" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0925" bpmnElement="PP0933">
        <dc:Bounds x="27730" y="724" width="36" height="36" />
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP1021" bpmnElement="PP1103">
        <dc:Bounds x="27680" y="724" width="36" height="36" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27628" y="763" width="69" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Shape>
      <bpmndi:PP0227Shape id="PP0966" bpmnElement="PP0965">
        <dc:Bounds x="29700" y="592" width="36" height="36" />
      </bpmndi:PP0227Shape>
      ...
      <bpmndi:PP0227Edge id="PP1947" bpmnElement="PP1946">
        <di:waypoint x="25013" y="570" />
        <di:waypoint x="25090" y="570" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP2210" bpmnElement="PP2209">
        ...
        <di:waypoint x="25781" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1420" bpmnElement="PP1419">
        <di:waypoint x="24078" y="595" />
        <di:waypoint x="24078" y="900" />
        <di:waypoint x="24636" y="900" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1268" bpmnElement="PP1267">
        <di:waypoint x="24736" y="900" />
        <di:waypoint x="24988" y="900" />
        <di:waypoint x="24988" y="595" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP2009" bpmnElement="PP2008">
        <di:waypoint x="25495" y="570" />
        <di:waypoint x="25580" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2066" bpmnElement="PP2065">
        <di:waypoint x="25470" y="595" />
        <di:waypoint x="25470" y="690" />
        <di:waypoint x="25612" y="690" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1826" bpmnElement="PP1825">
        <di:waypoint x="25648" y="690" />
        <di:waypoint x="25806" y="690" />
        <di:waypoint x="25806" y="595" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP2206" bpmnElement="PP2205">
        <di:waypoint x="27751" y="570" />
        <di:waypoint x="27996" y="570" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27867" y="548" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1943" bpmnElement="PP1942">
        <di:waypoint x="27726" y="595" />
        <di:waypoint x="27726" y="662" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27741" y="626" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1672" bpmnElement="PP1671">
        <di:waypoint x="27776" y="702" />
        <di:waypoint x="27861" y="702" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1447" bpmnElement="PP1446">
        <di:waypoint x="27911" y="702" />
        <di:waypoint x="27996" y="702" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27953" y="684" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2058" bpmnElement="PP2057">
        <di:waypoint x="28458" y="570" />
        <di:waypoint x="28545" y="570" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP1531" bpmnElement="PP1530">
        <di:waypoint x="29140" y="570" />
        <di:waypoint x="29227" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0277" bpmnElement="PP2039">
        <di:waypoint x="29549" y="570" />
        <di:waypoint x="29668" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2197" bpmnElement="PP2196">
        <di:waypoint x="29638" y="647" />
        <di:waypoint x="29638" y="600" />
        <di:waypoint x="29668" y="600" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0262" bpmnElement="PP1491">
        <di:waypoint x="29768" y="570" />
        <di:waypoint x="29869" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0263" bpmnElement="PP1385">
        <di:waypoint x="29969" y="570" />
        <di:waypoint x="30030" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0253" bpmnElement="PP2226">
        <di:waypoint x="29252" y="805" />
        <di:waypoint x="29252" y="915" />
        <di:waypoint x="29338" y="915" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0258" bpmnElement="PP1847">
        <di:waypoint x="29438" y="915" />
        <di:waypoint x="29524" y="915" />
        <di:waypoint x="29524" y="805" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0242" bpmnElement="PP1416" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="29277" y="570" />
        <di:waypoint x="29499" y="570" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="29352" y="552" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0266" bpmnElement="PP1291">
        <di:waypoint x="29524" y="755" />
        <di:waypoint x="29524" y="595" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0273" bpmnElement="PP2202">
        <di:waypoint x="29252" y="703" />
        <di:waypoint x="29252" y="755" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0283" bpmnElement="PP1390">
        <di:waypoint x="29277" y="780" />
        <di:waypoint x="29338" y="780" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0298" bpmnElement="PP1609">
        <di:waypoint x="29438" y="780" />
        <di:waypoint x="29499" y="780" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0303" bpmnElement="PP1862" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="29252" y="595" />
        <di:waypoint x="29252" y="667" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="29270" y="608" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0304" bpmnElement="PP1343" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="28682" y="595" />
        <di:waypoint x="28682" y="698" />
        <di:waypoint x="28770" y="698" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="28705" y="683" width="11" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1888" bpmnElement="PP1887">
        <di:waypoint x="29718" y="628" />
        <di:waypoint x="29718" y="665" />
        <di:waypoint x="29656" y="665" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1855" bpmnElement="PP1854">
        <di:waypoint x="28288" y="570" />
        <di:waypoint x="28358" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1288" bpmnElement="PP1287">
        <di:waypoint x="28096" y="570" />
        <di:waypoint x="28188" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1366" bpmnElement="PP1365">
        <di:waypoint x="27886" y="677" />
        <di:waypoint x="27886" y="590" />
        <di:waypoint x="27996" y="590" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27891" y="631" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2158" bpmnElement="PP2157">
        <di:waypoint x="28046" y="662" />
        <di:waypoint x="28046" y="610" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1783" bpmnElement="PP1782">
        <di:waypoint x="27698" y="760" />
        <di:waypoint x="27698" y="800" />
        <di:waypoint x="27568" y="800" />
        <di:waypoint x="27568" y="702" />
        <di:waypoint x="27676" y="702" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1426" bpmnElement="PP1425">
        <di:waypoint x="27748" y="760" />
        <di:waypoint x="27748" y="800" />
        <di:waypoint x="27886" y="800" />
        <di:waypoint x="27886" y="727" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27759" y="763" width="57" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0289" bpmnElement="PP1367">
        <di:waypoint x="26501" y="700" />
        <di:waypoint x="26575" y="700" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0299" bpmnElement="PP2031">
        <di:waypoint x="26675" y="700" />
        <di:waypoint x="26816" y="700" />
        <di:waypoint x="26816" y="595" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0287" bpmnElement="PP1657" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="25943" y="570" />
        <di:waypoint x="26791" y="570" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25987" y="552" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0300" bpmnElement="PP1794">
        <di:waypoint x="25918" y="595" />
        <di:waypoint x="25918" y="700" />
        <di:waypoint x="25993" y="700" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="25936" y="610" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1541" bpmnElement="PP1540">
        <di:waypoint x="26650" y="822" />
        <di:waypoint x="26816" y="822" />
        <di:waypoint x="26816" y="595" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26689" y="833" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1399" bpmnElement="PP1398">
        <di:waypoint x="26011" y="930" />
        <di:waypoint x="26011" y="718" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0243" bpmnElement="PP2038">
        <di:waypoint x="26029" y="700" />
        <di:waypoint x="26103" y="700" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0288" bpmnElement="PP1448">
        <di:waypoint x="26203" y="700" />
        <di:waypoint x="26277" y="700" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0260" bpmnElement="PP1803" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="26327" y="700" />
        <di:waypoint x="26401" y="700" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26348" y="680" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0264" bpmnElement="PP1451" bioc:stroke="#000" bioc:fill="#fff">
        <di:waypoint x="26302" y="725" />
        <di:waypoint x="26302" y="804" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26320" y="740" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1674" bpmnElement="PP1673">
        <di:waypoint x="26625" y="758" />
        <di:waypoint x="26625" y="797" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1579" bpmnElement="PP1578">
        <di:waypoint x="26625" y="847" />
        <di:waypoint x="26625" y="923" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26630" y="863" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1301" bpmnElement="PP1300">
        <di:waypoint x="26600" y="948" />
        <di:waypoint x="26029" y="948" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26550" y="955" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1338" bpmnElement="PP1337">
        <di:waypoint x="26650" y="948" />
        <di:waypoint x="26766" y="948" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="26689" y="955" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2164" bpmnElement="PP2163">
        <di:waypoint x="26841" y="908" />
        <di:waypoint x="26841" y="883" />
        <di:waypoint x="26791" y="883" />
        <di:waypoint x="26791" y="908" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2190" bpmnElement="PP2189">
        <di:waypoint x="26841" y="570" />
        <di:waypoint x="26891" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1629" bpmnElement="PP1628">
        <di:waypoint x="25831" y="570" />
        <di:waypoint x="25893" y="570" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP2137" bpmnElement="PP2136">
        <di:waypoint x="21828" y="740" />
        <di:waypoint x="21828" y="792" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1773" bpmnElement="PP1772">
        <di:waypoint x="21878" y="758" />
        <di:waypoint x="21878" y="792" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2148" bpmnElement="PP2147">
        <di:waypoint x="21878" y="828" />
        <di:waypoint x="21878" y="878" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1411" bpmnElement="PP1410">
        <di:waypoint x="21828" y="828" />
        <di:waypoint x="21828" y="878" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2100" bpmnElement="PP2099">
        <di:waypoint x="21858" y="958" />
        <di:waypoint x="21858" y="1002" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2082" bpmnElement="PP2081">
        <di:waypoint x="21908" y="221" />
        <di:waypoint x="21908" y="181" />
        <di:waypoint x="22222" y="181" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2084" bpmnElement="PP2083">
        <di:waypoint x="22620" y="251" />
        <di:waypoint x="23570" y="251" />
        <di:waypoint x="23570" y="545" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2078" bpmnElement="PP2077">
        <di:waypoint x="21908" y="289" />
        <di:waypoint x="21908" y="321" />
        <di:waypoint x="22222" y="321" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2086" bpmnElement="PP2085">
        <di:waypoint x="22258" y="181" />
        <di:waypoint x="22340" y="181" />
        <di:waypoint x="22340" y="211" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2080" bpmnElement="PP2079">
        <di:waypoint x="22258" y="321" />
        <di:waypoint x="22340" y="321" />
        <di:waypoint x="22340" y="291" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1256monta_body_para_formaliza_di" bpmnElement="PP1256monta_body_para_formaliza">
        <di:waypoint x="22390" y="251" />
        <di:waypoint x="22520" y="251" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP1870" bpmnElement="PP1869">
        ...
        <di:waypoint x="23800" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1569" bpmnElement="PP1568">
        <di:waypoint x="23900" y="570" />
        <di:waypoint x="23945" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1712" bpmnElement="PP1711">
        <di:waypoint x="23995" y="570" />
        <di:waypoint x="24053" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1618" bpmnElement="PP1617">
        <di:waypoint x="23570" y="595" />
        <di:waypoint x="23570" y="690" />
        <di:waypoint x="23970" y="690" />
        <di:waypoint x="23970" y="595" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="23761" y="672" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2180" bpmnElement="PP2179">
        <di:waypoint x="23378" y="570" />
        <di:waypoint x="23545" y="570" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP1563" bpmnElement="PP1562">
        <di:waypoint x="23595" y="570" />
        <di:waypoint x="23650" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1894" bpmnElement="PP1893">
        <di:waypoint x="26916" y="595" />
        <di:waypoint x="26916" y="677" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1636" bpmnElement="PP1635">
        <di:waypoint x="26941" y="702" />
        <di:waypoint x="26986" y="702" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP2156" bpmnElement="PP2155">
        <di:waypoint x="27226" y="702" />
        <di:waypoint x="27251" y="702" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1771" bpmnElement="PP1770">
        <di:waypoint x="27276" y="677" />
        <di:waypoint x="27276" y="595" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1732" bpmnElement="PP1731">
        <di:waypoint x="26916" y="727" />
        <di:waypoint x="26916" y="790" />
        <di:waypoint x="27276" y="790" />
        <di:waypoint x="27276" y="727" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="27063" y="756" width="75" height="27" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP1902" bpmnElement="PP1901">
        <di:waypoint x="28570" y="545" />
        <di:waypoint x="28570" y="468" />
        <di:waypoint x="29869" y="468" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="28551" y="499" width="19" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1802" bpmnElement="PP1801">
        <di:waypoint x="28595" y="570" />
        <di:waypoint x="28657" y="570" />
        <bpmndi:PP0227Label>
          <dc:Bounds x="28616" y="552" width="21" height="14" />
        </bpmndi:PP0227Label>
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP1859" bpmnElement="PP1858">
        ...
        <di:waypoint x="30048" y="468" />
        <di:waypoint x="30048" y="552" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP2088" bpmnElement="PP2087">
        <di:waypoint x="21858" y="425" />
        <di:waypoint x="21858" y="291" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP1551" bpmnElement="PP1550">
        <di:waypoint x="21883" y="450" />
        <di:waypoint x="22008" y="450" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP12561xitkq0_di" bpmnElement="PP12561xitkq0">
        <di:waypoint x="21858" y="595" />
        <di:waypoint x="21858" y="660" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP12560hfkaa8_di" bpmnElement="PP12560hfkaa8">
        <di:waypoint x="21720" y="570" />
        <di:waypoint x="21833" y="570" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP12560yh6u85_di" bpmnElement="PP12560yh6u85">
        <di:waypoint x="21858" y="545" />
        <di:waypoint x="21858" y="475" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0182" bpmnElement="PP0181">
        <di:waypoint x="24443" y="692" />
        <di:waypoint x="24451" y="673" />
      </bpmndi:PP0227Edge>
      <bpmndi:PP0227Edge id="PP0184" bpmnElement="PP0183">
        <di:waypoint x="24447" y="800" />
        <di:waypoint x="24446" y="801" />
      </bpmndi:PP0227Edge>
      ...
      <bpmndi:PP0227Edge id="PP0297" bpmnElement="PP0180">
        <di:waypoint x="22236" y="694" />
        <di:waypoint x="22222" y="678" />
      </bpmndi:PP0227Edge>
    </bpmndi:PP0227Plane>
