...
| Opção | Descrição | Prós | Contras |
| ------- | ----------- | ------ | --------- |
| **Sem estado próprio (nova KK0780)** | Cada vez que o KK0995 reabre a KK0206, o KK0639 inicia **do início** (nova KK0780). O front **reexibe a KK1338 com dados já preenchidos** a partir das **KK1423 de KK1069** (KK0995/KK0639) já persistidas. | KK0371 simples; menos lógica de ponto de parada no engine; dados preenchidos garantidos pelo KK0374; reduz KK1201 de estado inconsistente. | Depende de o KK0372 KK0995/KK0639 expor todas as KK1423 necessárias para o front preencher a KK1338; sensação de "voltei exatamente onde estava" é dada pelo front, não pelo engine. |
| **Retomada em ponto de parada** | O engine reabre o KK0639 em uma **tarefa de KK1392 ou estado específico**, com estado restaurado pelo engine. | KK1393 de "voltei exatamente onde estava" com estado restaurado pelo engine. | Exige definição de KK1039 de parada por KK0639, KK1012 e rota de retomada; mais complexidade no engine e no KK0172; KK1201 de estado inconsistente se mal modelado. |
...
- **Simplicidade KK0967:** reduzir complexidade de execução no engine KK0172.
...
- Os KK0640 (KK0173–4) são tratados como **sem estado próprio** ao reabrir: cada reentrada = **nova KK0780** do KK1069 KK0639; o front reconstrói a KK1338 a partir das KK1423 de KK1069 (KK0995 e KK0639) conforme KK0372.
...
> **KK0362:** KK1006 do [KK0846](../KK0789%20da%20decomposição/KK0846). Quando o KK1392 clica em **KK1452** numa etapa (ex.: KK1078), o KK0995 precisa sair do KK0639 atual e reabrir o KK0639 anterior (ex.: KK0407). Duas formas de implementar: (A) mensagem de fora + KK0168 no KK0995; (B) KK0639 termina e devolve KK1423.  
> **Status:** **Em KK0064** (decisão KK1086: KK0968; aguarda duas aprovações — ver [PADRAO_ADR_VISIONING.md](PADRAO_ADR_VISIONING.md)). Resumo da decisão KK1086: lógica do KK1451 na macro (KK0995); KK0144 envia mensagem; KK0168 em cada KK0206; KK0668 “para onde KK1451?” no KK0995.
...
### KK0968 — Mensagem de fora

**Descrição:** KK0666/KK0144 envia **mensagem** ao KK1069 (ex.: `KK1459 = "dados_pessoais"`). No KK0995, um **KK0168** em cada KK0207 escuta essa mensagem; ao receber, **cancela** a KK0206 e devolve o controle ao KK0995. O KK0995 usa um **KK0668 "para onde KK1451?"** e reabre o KK0639 correspondente.

- **Prós:** Lógica do KK1451 **só no KK0995**; KK0640 não precisam conhecer "KK1456". Um só lugar para alterar (KK0995 + KK0372 KK0144). Semântica clara: "interromper e redirecionar". Outros disparadores (KK0135, KK0140) podem enviar a mesma mensagem.
- **Contras:** Exige envio de mensagem (KK0144 → engine) e KK0165 Event em cada KK0206 onde há KK1452.

### KK0969 — Filho devolve KK1423

**Descrição:** O **KK0639** (ex.: KK0176), quando o KK1392 clica KK1452, **completa** a KK0780 com KK1423 de saída (`KK1457=true`, `KK1459="dados_pessoais"`). A KK0208 KK1186 normalmente; o KK0995 tem um KK0668 após cada KK0206 ("veio KK1451?") e o KK0668 "para onde KK1451?".

- **Prós:** Não depende de mensagem externa; tudo no KK1187 da KK0206.
- **Contras:** A regra fica **em cada KK0639**: cada um precisa preencher e devolver as KK1423. Filhos deixam de ser "genéricos"; mudança futura exige tocar em vários KK0183.

**KK0650 KK1378 da KK0969 (para reversibilidade da decisão):** Na KK0969 não há mensagem externa nem KK0165 Event. O KK1392 clica KK1452 na KK1338 (ex.: KK1078); o **front/KK0144** informa o **KK0639** (ex.: KK1069 da KK0206 KK1078) — por exemplo via KK1424 de KK1069 ou sinalização na mesma sessão. O **KK0639** então **encerra a própria KK0780** (KK0308 KK1332 / end process) passando KK1423 de saída para a KK0208: `KK1457=true` e `KK1459=<destino>`. A **KK0208 KK1186** ao KK0995 com essas KK1423. O KK0995 tem, **após cada KK0206** (exceto talvez a última antes do Fim), um **KK0668 “veio KK1451?”** que lê `KK1457`; se true, segue para o **KK0668 “para onde KK1451?”** (que usa `KK1459`) e reabre a KK0206 correspondente; senão, segue para a próxima KK0206 na KK1272. Assim, **cada KK0639** (KK0407, KK1078, KK1405) precisa (1) conhecer o conceito “KK1456”, (2) receber a intenção do KK1392 (via front/KK0144 ou KK1424), (3) preencher e devolver as KK1423 ao terminar. A lógica de “para onde” pode ficar no KK0995 (KK0669), mas a **decisão de terminar devolvendo “KK1451”** e o **KK0374** ficam em todo KK0639 que participa do KK1451.

*Sequência resumida (KK0969):*
...
- O KK0995 terá **KK0168** (ex.: `KK0864`) nas Calls de **KK0407, KK1078 e KK1405** (não em KK0316).
...
- **KK1006 do N1:** Fechar como **“Decidido: KK0968 — mensagem + KK0168 no KK0995; lógica na macro. Ver KK0462.”**
...
**Apresentações** não é eixo de KK1139; conteúdo arquivado em [Apresentações/out/](Apresentações/out/). Ver [Apresentações/README.md](Apresentações/README.md).
...
| [REFERENCIA_CRUZADA_MULTIPLO_SETUP_MANUAL.md](../Manual%20OMNICHANNEL/REFERENCIA_CRUZADA_MULTIPLO_SETUP_MANUAL.md) | Onde KK0898, KK1284 e Manual se tocam; §7 KK1438. |
| [REFERENCIA_CRUZADA_VISIONING_MANUAL.md](REFERENCIA_CRUZADA_VISIONING_MANUAL.md) | Onde o KK1439 toca o Manual (inventários N1/KK0903/KK0904, KK0040, KK0084) e onde o Manual KK1138 o KK1439. |
...
Para visão resumida e links de KK1139 cruzada, use também [README_VISIONING.md](README_VISIONING.md). Para acompanhamento de KK1007, use [TODO_VISIONING_16-03_UNIFICADO.md](../planos_e_todos_visioning/TODO_VISIONING_16-03_UNIFICADO.md).
...
### 3.3.1 Detalhamento: KK0711 e KK0165 KK0612 do KK1452 (KK0968)
...
**Onde existe KK0168:** em cada KK0206 em que o KK1392 pode apertar KK1452 — **KK0407 (P2), KK1078 (P3), KK1405 (P4)**. Em **KK0316 (P1)** não (não há "KK1451" para antes do KK0995).

**KK0668 "Para onde KK1451?"** — após o KK0165 Event disparar, o KK0995 usa este KK0669 com uma saída por destino:
...
| Documento | Uso |
| ----------- | ----- |
| `KK0848` | Conteúdo de cada KK0639 chamado pelo KK0995 |
| `KK0075` | KK0491 KK0995 e KK0187 |
| `KK0818` | Metodologia do levantamento nível 2 |
| `KK0462` | KK0466: KK1456 = KK0968 (mensagem + KK0165 Event no KK0995) |
| `KK1458` | Explicação do KK1456 com analogias e KK0493 (KK0865) |
| `KK0458` | KK0466: preservação de estado ao reabrir KK0639 = KK1308 na primeira entrega |
...
**Manual (partes):** [KK1000 1](<documentacao/Manual KK0950/parte_01_inicio_identificacao_jornada/KK0652.md>), [KK1000 2](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>), [KK1000 3](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>), [KK1000 4](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>), [KK1000 5](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>), [KK1000 6](<documentacao/Manual KK0950/parte_06_backoffice_wayout_analise_documentos/FLUXO_06_tecnico.md>), [KK1000 12](<documentacao/Manual KK0950/parte_12_pos_efetivacao_setup_vinculo_proxy/FLUXO_12_tecnico.md>).

> **Etapa:** ① KK0317 (stepper)  
> **KK0263 KK0282:** entrada em [KK0596](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>)  
> **Ponto de não-KK1187:** após [KK1262](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>) → KK0496 consultado, KK0936 iniciada
...
| ID | Nome | Observação |
| --- | --- | --- |
| [KK0596](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>) | KK0595 | Primeira UT da etapa
| [KK0597](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>) | Envio KK0522 | Condicional: KK1384 ou situação especial
| [KK1262](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>) | KK1261 | Última UT — ponto de corte para KK0175
| [KK0415](<documentacao/Manual KK0950/parte_13_beneficio_inss/FLUXO_13_tecnico.md>) | Benefício KK0776 | Condicional: toggle KK0776 ativo
| [KK0769](<documentacao/Manual KK0950/parte_06_backoffice_wayout_analise_documentos/FLUXO_06_tecnico.md>) | KK0768 | KK1311: KK1375 (portabilidade KK1211)
| [KK0319](<documentacao/Manual KK0950/parte_06_backoffice_wayout_analise_documentos/FLUXO_06_tecnico.md>) | KK0321 | KK1311: KK1375
| [KK0564](<documentacao/Manual KK0950/parte_06_backoffice_wayout_analise_documentos/FLUXO_06_tecnico.md>) | KK0563 | Exceção KK0967
| [KK1258](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>) | KK1253 KK0926 | Estado de exceção
| [KK0906](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>) | KK0927 | Estado de exceção
| [KK1177](<documentacao/Manual KK0950/parte_16_eventos_transversais_excecoes/FLUXO_16_tecnico.md>) | Restrição KK0129 | Estado de exceção
| [KK0043](<documentacao/Manual KK0950/parte_16_eventos_transversais_excecoes/FLUXO_16_tecnico.md>) | KK0588 | Estado de erro
| [KK0589](<documentacao/Manual KK0950/parte_16_eventos_transversais_excecoes/FLUXO_16_tecnico.md>) | KK0588 | Estado de erro
| [KK0590](<documentacao/Manual KK0950/parte_16_eventos_transversais_excecoes/FLUXO_16_tecnico.md>) | KK0588 | Estado de erro
...
| `KK0503` | Atualiza dados KK0497 na KK1086 | ⚙️ | Após KK0497, antes de [KK0417](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) |
...
| `KK0709` | — | Elegibilidade: ok → [KK0415](<documentacao/Manual KK0950/parte_13_beneficio_inss/FLUXO_13_tecnico.md>), não → `KK0908` |
| `KK0697` | — | Após [KK0596](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>): precisa de upgrade? |
| `KK0689` | Pode mudar KK1254? | Permite re-KK1251 ou não |
| `KK0686` | Possui Residência no Exterior? | Após [KK0420](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>): SIM → [KK0416](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>), NÃO → [KK1262](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>) |

---

## KK0175 — `KK0957`

**Manual (partes):** [KK1000 2](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>), [KK1000 3](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>).
...
| ID | Nome | Observação |
| --- | --- | --- |
| [KK0417](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) | nome | Primeira UT — abre KK0408 |
| [KK0421](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>) | KK0426 | ⚠️ Nova KK0797: front KK0721 como sub-KK1338 |
| [KK0413](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>) | KK0405 | ⚠️ Nova KK0797: front KK0721 como sub-KK1338 |
| [KK0411](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>) | KK0402 | ⚠️ Nova KK0797: front KK0721 como sub-KK1338 |
| [KK0416](<documentacao/Manual KK0950/parte_02_cadastro_inicial_dados_contato/FLUXO_02_tecnico.md>) | KK0399 KK0912 | Condicional: KK0273 com KK1164 fiscal no KK0624 |
| [KK0414](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) | Endereço | ⚠️ Nova KK0797: front KK0721 como sub-KK1338 |
| [KK0420](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) | KK1155 | Última UT — KK0282 segue para KK0046/KK1254 (KK0651 atual) |
...
**Manual (partes):** [KK1000 5](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>), [KK1000 6](<documentacao/Manual KK0950/parte_06_backoffice_wayout_analise_documentos/FLUXO_06_tecnico.md>), [KK1000 7](<documentacao/Manual KK0950/parte_07_limites_oferta_mapeamento_ge/FLUXO_07_tecnico.md>), [KK1000 8](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>), [KK1000 12](<documentacao/Manual KK0950/parte_12_pos_efetivacao_setup_vinculo_proxy/FLUXO_12_tecnico.md>).

> **Etapa:** ③ KK1078 e KK1279 (stepper)  
> **KK0263 KK0282:** entrada em [KK0406](<documentacao/Manual KK0950/parte_07_limites_oferta_mapeamento_ge/FLUXO_07_tecnico.md>)  
> **Ponto de não-KK1187:** após [KK0016](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) → KK0985
...
| ID | Nome | Observação |
| --- | --- | --- |
| [KK0406](<documentacao/Manual KK0950/parte_07_limites_oferta_mapeamento_ge/FLUXO_07_tecnico.md>) | KK0399 Oferta | Primeira UT — recebe `KK0946` + `KK0939` |
| [KK0016](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) | Aceite KK1078 | Ponto de não-KK1187 — KK0982 é gerado após aqui |
| [KK0412](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) | Declarações | Declarações do KK0273 |
| [KK1349](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) | Termo Autorização KK0332 | Termo legal |
| [KK0329](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) | Consentimento Débito | Condicional: KK0273 com KK0528 |
| [KK1348](<documentacao/Manual KK0950/parte_13_beneficio_inss/FLUXO_13_tecnico.md>) | KK1345 | Condicional: KK0776 ativo |
| [KK0592](<documentacao/Manual KK0950/parte_12_pos_efetivacao_setup_vinculo_proxy/FLUXO_12_tecnico.md>) | Erro Vincular KK1125 | Estado de erro: KK1126 |

### KK1277 / KK1247

| ID | Nome | Tipo | Observação |
| --- | --- | --- | --- |
| `KK0336` | KK0332 | ⚙️ External (`KK0966`) | KK0835 [KK0016](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) |
...
**Manual (partes):** [KK1000 9](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>), [KK1000 10](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>), [KK1000 11](<documentacao/Manual KK0950/parte_11_efetivacao_conta/FLUXO_11_tecnico.md>), [KK1000 12](<documentacao/Manual KK0950/parte_12_pos_efetivacao_setup_vinculo_proxy/FLUXO_12_tecnico.md>), [KK1000 13](<documentacao/Manual KK0950/parte_13_beneficio_inss/FLUXO_13_tecnico.md>), [KK1000 14](<documentacao/Manual KK0950/parte_14_pld_mesa_pld/FLUXO_14_tecnico.md>), [KK1000 15](<documentacao/Manual KK0950/parte_15_pac_envios_finalizacao/FLUXO_15_tecnico.md>), [KK1000 16](<documentacao/Manual KK0950/parte_16_eventos_transversais_excecoes/FLUXO_16_tecnico.md>).

> **Etapa:** ④ KK1405 (stepper)  
> **KK0263 KK0282:** entrada em [KK0409](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>)  
> **Ponto de não-KK1187:** após KK0149 aprovada / após [KK1110](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>)
...
| ID | Nome | Observação |
| --- | --- | --- |
| [KK0409](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | KK0399 KK0148 | Wait state — KK0273 faz KK0149 (QR/WhatsApp/SMS) |
| [KK0151](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | KK0148 recusada | Estado de exceção |
| [KK0154](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | KK0150 | Estado de exceção |
| [KK0301](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | KK0298 de KK1266 | KK0272 cria KK1267 do KK0245 |
| [KK1184](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | Resumo KK0345 | Confirmação final |
| [KK1110](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>) | KK1085 Liberada | Last UT — loop até KK1110==true |

### KK1277 / KK1247 / BusinessRuleTasks

| ID | Nome | Tipo | Observação |
| --- | --- | --- | --- |
| `KK0052` | Analisa Score KK0148 Selfie | 🔀 BusinessRule (KK0514) | Após [KK0409](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) — classifica resultado |
...
| `KK0105` | Atualiza KK1095 e KK0470 | ⚙️ KK0473 | Após [KK1110](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>)==true |
...
| `KK0718` | KK0715 | ⚙️ External (`KK0808`) | Após [KK1110](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>) |
...
| `KK0691` | — | Tem representante? → direciona para [KK0409](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) |

---

## KK0543 — `KK0959` (KK0208 pós-KK0797)

> **Quando:** após [KK1110](<documentacao/Manual KK0950/parte_10_validacao_pre_efetivacao_liberacao/FLUXO_10_tecnico.md>) / `gerar_pac` — roda em background  
...
| --- | --- | --- | --- |
| `Flow_11m3pcg` | [KK0417](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) | [KK0596](<documentacao/Manual KK0950/parte_05_segmentacao_direcionador/FLUXO_05_tecnico.md>) | KK0175 → KK0173 via KK0995 |
| `Flow_03fc21n` | [KK0406](<documentacao/Manual KK0950/parte_07_limites_oferta_mapeamento_ge/FLUXO_07_tecnico.md>) | [KK1262](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>) | KK0176 → KK0173 via KK0995 |
| `KK0648` | [KK0016](<documentacao/Manual KK0950/parte_08_produtos_aceite_termos/FLUXO_08_tecnico.md>) | [KK0301](<documentacao/Manual KK0950/parte_09_biometria_coleta_senha/FLUXO_09_tecnico.md>) | KK0176 → KK0177 via KK0995 (KK1451 para KK0301) — ver `KK0454` |

### Flow de avanço — KK1272 KK0995 (1→2)

| Flow ID | De (KK1332) | Para (KK1332) | KK0172 futuro |
| --- | --- | --- | --- |
| `Flow_0ca3z8j` | [KK1262](<documentacao/Manual KK0950/parte_04_selecao_agencia_proposta_segmentada/FLUXO_04_tecnico.md>) | [KK0414](<documentacao/Manual KK0950/parte_03_dados_pessoais_nome_endereco_renda/FLUXO_03_tecnico.md>) | KK0173 → KK0175 via KK0995 |
...
**KK1025 de otimização/organização (modelo Manual):** [PLANO_OTIMIZACAO_ORGANIZACAO_APRIMORAMENTO_VISIONING.md](PLANO_OTIMIZACAO_ORGANIZACAO_APRIMORAMENTO_VISIONING.md) — fases para alinhar o KK1439 ao padrão do Manual KK0950 (índice único, KK0578/saídas, KK1139 cruzada, glossário).

**Índice e KK1007:** [INDICE_VISIONING.md](INDICE_VISIONING.md) — tabela mestre por eixo e referências cruzadas; [TODO_VISIONING_16-03_UNIFICADO.md](../planos_e_todos_visioning/TODO_VISIONING_16-03_UNIFICADO.md) — checklist de KK1007.

**Referências cruzadas (KK1438 × Manual × KK0898/KK1282):**

- [REFERENCIA_CRUZADA_VISIONING_MANUAL.md](REFERENCIA_CRUZADA_VISIONING_MANUAL.md) — onde o KK1439 toca o Manual (inventários N1/KK0903/KK0904, KK0040, KK0084) e onde o Manual KK1138 o KK1439; KK0910 bidirecional.
- [REFERENCIA_CRUZADA_MULTIPLO_SETUP_MANUAL.md](../Manual%20OMNICHANNEL/REFERENCIA_CRUZADA_MULTIPLO_SETUP_MANUAL.md) — onde KK0898, KK1284 e Manual se tocam (§6 KK0577/saídas Partes 5, 7, 8, 12; §7 KK1438).
- Manual: [INDICE_E_PLANEJAMENTO_MANUAL_CO8.md](../Manual%20OMNICHANNEL/INDICE_E_PLANEJAMENTO_MANUAL_CO8.md) — índice das 16 partes e §5 referências.
...
**Os arquivos nesta pasta (fora de `out/`) são a KK1139.** A pasta `out/` contém backup ou cópias — não use como fonte. KK0655 do KK0651: `KK0953` (raiz do repositório).

**Padronização:** [PLANO_REORGANIZACAO_PASTA_ARQUITETURA.md](PLANO_REORGANIZACAO_PASTA_ARQUITETURA.md) — tipos de KK0521, template por tipo, KK1351 em PT, vínculo com Manual e KK0493; aplicação em fases.
...
**Objetivo:** Especificar o mecanismo de KK1451 entre etapas (KK0968): mensagem externa (KK0144), KK0168 no KK0995, cancelamento da KK0206 ativa e KK0669 "para onde KK1451?"; inclui KK0372 de correlação, governança do KK0669 e mitigação de KK1206.
...
**Convenção de cores (padrão único em todo o KK0521):** igual ao Manual KK0950. KK0816: **KK1426** = início; **KK0127** = user KK1332 / etapa; **KK0269** = service/KK1223; **âmbar** = KK0669; **KK1430** = fim ou erro; KK1281 tracejada = KK0651 "KK1451". Códigos (KK0865): verde `#c8e6c9`/`#2e7d32`, KK0127 `#bbdefb`/`#1565c0`, KK0269 `#eceff1`/`#546e7a`, âmbar `#fff8e1`/`#e65100`, KK1430 `#ffcdd2`/`#c62828`. Setas: `linkStyle KK0472 stroke:#37474f,stroke-width:2px`. Flowcharts em **LR**. Referência: [DIAGRAM_STYLE_GUIDE.md](../DIAGRAM_STYLE_GUIDE.md).

---

## 1. Mensagem de KK1451 vinda de fora (KK0144 → engine)

O KK1392 solicita KK1451 pela KK1338; o app (KK0144) envia uma **mensagem** para o KK1069. O KK0995 possui um **KK0168** em cada KK0206 onde faz sentido KK1451. Quando a mensagem chega, a KK0206 atual é **interrompida** e o KK0995 decide para qual KK0206 ir.

### 1.1 KK0168 na KK0206 (conceito)

**Ideia em uma linha:** o KK1361 está na KK0206 KK1078; o KK1392 clica KK1452; o KK0144 envia a mensagem; o KK0165 Event recebe e o KK0995 interrompe a KK0206.
...
O **KK0168** fica ativo na borda da KK0206 enquanto o KK1361 está dentro dela. Quando a mensagem chega, o KK0610 **dispara**, a KK0206 é **cancelada** e o KK0995 decide para qual KK0206 ir em seguida.
...
Sequência do KK0995: **Início → KK0206 Config → KK0206 KK0407 → KK0206 KK1078 → KK0206 KK1405 → Fim**. Apenas as Calls 2, 3 e 4 têm KK0168; na KK0206 Config não há KK1451 para antes do KK0995.
...
stateDiagram-v2
  ...
  KK0507: KK0206 cancelada, controle volta ao KK0995
  KK0507 --> [*]: KK0995 segue para KK0668 voltar_para
  style Escutando fill:#fff8e1,stroke:#e65100,stroke-width:2px
  style KK0507 fill:#ffcdd2,stroke:#c62828,stroke-width:2px
```

*Amarelo = estado ativo/esperando; KK1430 = disparado; KK1281 = transição.*
...
*KK1426 = início; KK0127 = user KK1332 / etapa; KK0269 = service/KK1223; âmbar = KK0669; KK1430 = fim ou erro.*
...
classDef finish fill:#ef4444,stroke:#991b1b,stroke-width:2px,color:#ffffff;
  ...
  style Reabre fill:#eceff1,stroke:#546e7a,stroke-width:2px
  linkStyle KK0472 stroke:#37474f,stroke-width:2px
```
...
stateDiagram-v2
  ...
  state "P1, P2 ou P3 (destino)" as destino
  atual --> destino : KK0610 KK1451 / KK0669 KK1459
  style atual fill:#fff8e1,stroke:#e65100,stroke-width:2px
  style destino fill:#bbdefb,stroke:#1565c0
```

---

## 4. KK1197 de padronização dos KK0493

**Referência:** PLANO_OTIMIZACAO_ORGANIZACAO_APRIMORAMENTO_VISIONING.md §2.1 (padrão visual para KK0493).

**KK0991 adotado neste KK0521:** paleta única de **5 cores** em todos os KK0493 (verde `#c8e6c9`, KK0127 `#bbdefb`, KK0269 `#eceff1`, âmbar `#fff8e1`, KK1430 `#ffcdd2`). Flowcharts de **KK0651 linear** em **LR** (esquerda → direita); KK0654 em árvore (ex.: §1.3.1) permanecem em TB.

| KK0491 | Local | Padronização | KK0816 |
|----------|--------|--------------|---------|
| Flowchart conceito KK0165 Event | §1.1 | 5 cores: início/KK0610 verde, ação KK0269, fim KK1430 | Sim (antes) |
| Flowchart Calls com/sem BE | §1.2 | KK0206 KK0127 (#bbdefb) | Sim (antes) |
| stateDiagram estados BE | §1.2 | Ativo amarelo, disparado KK1430 | Sim (após) |
| sequenceDiagram KK0651 passo a passo | §1.3 | Tema KK0127 (#bbdefb); ativações mesma cor (KK0206/etapa) | Sim (após) |
| Flowchart participantes (LR) | §1.3 | 5 cores: KK0127 = etapa (KK0995/KK0206/Filho), KK0269 = ação (U/KK0144), verde = KK0610 (BE) | Sim (após) |
| Flowchart KK0668 decide destino | §1.3.1 | TB (árvore). KK0609 verde, GW amarelo, KK0206 KK0127, erro KK1430, reabertura KK0269 | Sim (antes) |
| Flowchart KK0206 destino termina | §1.3.2 | **LR**. Cinza atividade, GW amarelo, KK0206 KK0127 | Sim (antes) |
| Flowchart KK0651 principal | §1.4 | KK0206 KK0127, fim KK1430 | Sim (antes) |
| Flowchart KK0651 de exceção | §1.4 | **LR**. Cinza/verde/amarelo/KK0127 (5 cores) | Sim (adicionada) |
| Flowchart máquina de estados (normal) | §3 | LR. Início verde, etapas KK0127, fim KK1430 | Sim (antes) |
| stateDiagram KK0610 KK1451 | §3 | Etapa atual amarelo, destino KK0127 (5 cores) | Sim (após) |

**Melhorias aplicadas:** (1) KK0650 de exceção (§1.4): estilos e legenda; (2) Paleta única de 5 cores em todo o doc; (3) Sequence diagram §1.3 em KK0127 (KK0206/etapa); (4) Flowchart participantes §1.3 em 5 cores (KK0127/KK0269/verde); (5) Fluxos lineares §1.3.2 e §1.4 em LR.

**Convenção de cores (igual ao Manual):** KK1426 = início; KK0127 = user KK1332 / etapa; KK0269 = service/KK1223; âmbar = KK0669; KK1430 = fim ou erro; KK1281 tracejada = KK0651 "KK1451". Setas do sequence e do flowchart em tom neutro (ex.: KK0269 escuro).
