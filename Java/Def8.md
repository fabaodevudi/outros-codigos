...
> **Contexto:** Pendência de classificação no [kkkk3b](../kkkk5e%20da%20decomposição/kkkk3b). As kkkkiq `kkkkcn`, `kkkkd0` e `kkkkcc` precisam ser atribuídas ao kkkkgx (kkkkty) ou ao kkkkgz (kkkkwt e kkkkxt).

> **Decisão:** As três kkkkiq permanecem no **kkkkgz (kkkkwt e kkkkxt)**. Referenciar como **kkkkhk-DEC-003** em outros documentos.
...
- Se a kkkkml de kkkk7d/kkkksp servir para **direcionar o kkkkvr** (qual kkkk1o, qual produto mostrar), faz sentido junto de kkkkvg e kkkkvh.
...
| **kkkkcc** | `kkkkcc` é executada dentro do kkkkfl `kkkkdh`, configurado como `kkkkoy`, que representa a kkkkml assíncrona de kkkksq. kkkkyb: variável `kkkk1e` é setada em **`kkkken`** “Iniciar kkkktk rotativo”, que fica **após** `kkkkkz` (documentação do kkkkx9: *“O início dessa kkkkml só pode ser feito após atualizar os dados da kkkksy no cadastro temporário do kkkkhq”*). Ou seja, na **fronteira kkkkgy → kkkkgz** (fim dos kkkkl9 / início do contexto de kkkkss). |
